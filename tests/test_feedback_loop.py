...
from strategy.feedback_loop import FailurePattern, FeedbackLoop
...
def test_generate_hypotheses_empty_on_no_patterns():
    ...
    result = asyncio.get_event_loop().run_until_complete(fb.generate_hypotheses([], {}))
    assert result == []
